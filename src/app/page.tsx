...
export default function Home() {
  ...
  return (
    <main ref={container}>
      <section className="flex min-h-screen flex-col px-6 sm:px-10">
      ...
      <section className="flex min-h-screen items-center border-t border-line px-6 sm:px-10">
        <h2 className="font-display text-4xl text-muted sm:text-6xl">
          Próxima seção…
        </h2>
      </section>
    </main>
